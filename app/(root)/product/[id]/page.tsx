...
//       {showCheckoutForm && <CheckoutForm imageUrl={product.imageUrl} name={product.name} id={productId} quantity={qty} price={product.price} onClose={() => setShowCheckoutForm(false)} />}
